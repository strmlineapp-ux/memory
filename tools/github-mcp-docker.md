---
name: GitHub MCP Server (Docker) — Config & Python Testing Pattern
description: Docker MCP server config (41 tools), Python subprocess testing pattern, protocol rules and error codes
type: tools
---

## GitHub MCP Server (Docker) — `ghcr.io/github`
